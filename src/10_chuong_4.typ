...
#figure(
  ...
  caption: [
    Minh hoạ hai hệ chữ trong cùng một bộ font.
  ]
)
...
Giá trị FID càng thấp cho thấy phân bố của ảnh sinh càng tiệm cận với phân bố ảnh thật, đồng nghĩa với việc mô hình sinh ra ảnh vừa chân thực (realism) vừa đa dạng (diversity).
...
#figure(
  ...
  caption: [
    Ảnh hưởng của các thành phần M, R, S và CL đến hiệu năng mô hình trên tác vụ Latin → Hán tự.
  ]
) <tab:e2c_module>
...
#figure(
  ...
  caption: [
    Ảnh hưởng của các thành phần M, R, S và CL đến hiệu năng mô hình trên tác vụ Hán tự → Latin.
  ]
) <tab:c2e_module>
